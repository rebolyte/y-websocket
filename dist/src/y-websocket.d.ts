...
export class WebsocketProvider extends Observable<string> {
     ...
     */
    constructor(serverUrl: string, roomname: string, doc: Y.Doc, { connect, awareness, params, WebSocketPolyfill, resyncInterval, reconnectPredicate }?: {
        connect?: boolean;
...
export type reconnectPredicate = (unsuccessfulAttempts: number) => boolean;
